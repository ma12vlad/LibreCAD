...
<context>
    ...
    <message>
        ...
        <source>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Part library folder. The symbol library dxf files must be located in the subdirectories of this folder. The subfolder names will be displayed in the Library Browser. Menu: Widgets &gt; Dock Widgets &gt; Library Browser&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</source>
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Папка библиотеки объектов. Файлы библиотеки dxf должны быть расположены в подпапках. Имена подпапок будут отображаться в браузере библиотеки. Меню: Виджеты &gt; Стыкуемые виджеты &gt; Библиотека&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
